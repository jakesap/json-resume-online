  ...
  work: [
    {
      ...
      endDate: '',
      summary:
        'Lead engineer on the platform team, responsible for infrastructure and developer experience across 50+ engineers.',
      highlights: [
    ...
    },
    {
      ...
      endDate: '2020-02-28',
      summary:
        'Full stack development for a real-time SaaS analytics product serving 500+ enterprise customers.',
      highlights: [
    ...
    },
    {
      ...
      endDate: '2017-05-31',
      summary:
        'Delivered custom software solutions for clients across finance, healthcare, and retail sectors.',
      highlights: [
        'Developed HIPAA-compliant patient management system used by 20+ clinics',
        'Built automated trading data pipeline processing $2B in daily transactions',
  ...
  volunteer: [
    {
      ...
      highlights: [
        'Mentored 15+ bootcamp graduates through job placement',
        'Led bi-weekly code review sessions and mock technical interviews',
        'Co-organized annual civic tech hackathon with 200+ participants',
      ],
    },
    {
      ...
      highlights: [
        'Redesigned adoption portal, increasing online adoption inquiries by 150%',
        'Implemented automated email follow-up system for adopters',
      ],
    },
  ],
  education: [
  ...
  awards: [
    {
      ...
      awarder: 'Acme Corp',
      summary:
        'Recognized for outstanding contributions to platform reliability and developer productivity.',
    },
    {
  ...
  publications: [
    {
      ...
      summary:
        'A deep dive into patterns and anti-patterns learned from running 40+ Node.js microservices at scale.',
    },
    {
      ...
      summary:
        'Practical guide to implementing distributed tracing, metrics, and logging with OpenTelemetry.',
    },
  ],
  skills: [
    {
  ...
  references: [
    {
      ...
      reference:
        "John is one of the most impactful engineers I've had the pleasure of working with. His technical depth, communication skills, and ability to mentor others make him an invaluable team member.",
    },
    {
      name: 'Bob Chen — CTO, StartupXYZ',
      reference:
        'John architected our entire backend from scratch and delivered it ahead of schedule. His understanding of distributed systems and pragmatic approach to engineering is exceptionally rare.',
    },
  ],
  projects: [
    {
      ...
      highlights: [
        '2.4k GitHub stars, 300+ production users',
        'Featured in Node.js Weekly and JavaScript Digest',
        'Full OpenTelemetry compatibility with zero-config setup',
      ],
    ...
    },
    {
      ...
      highlights: [
        'Used by 50+ engineering teams in production',
        'Zero-downtime deployments with automatic rollback on failure',
        'Supports complex column type changes without table locking',
      ],
